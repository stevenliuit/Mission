...
from apps.models import Admin, AssetGroup, Server
...
class Tty(object):
    ...
    def get_connect_info(self):
        ...
        user_key = os.path.join(SSH_KEY_PATH, self.asset.osuser.username, self.user.user_name + '_' + self.asset.osuser.username)  # 获取角色的key，因为ansible需要权限是600，所以统一生成用户_角色key
